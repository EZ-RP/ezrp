...
class Employee(models.Model):
    ...
    start_date = models.DateField(help_text="The Date An Employees Started.")
    end_date = models.DateField(null=True, blank=True, help_text="The Date An Employees Ended.")
