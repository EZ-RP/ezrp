...
class VendorTable(tables.Table):
    ...
    edit_link = tables.LinkColumn('vendor', args=[A('pk')],
                                  verbose_name='Edit Vendor', text='Edit', accessor='pk',
                                  attrs={'class': 'edit_link'})

    delete_link = tables.LinkColumn('vendor_delete', args=[A('pk')],
                                    verbose_name='Delete Vendor', text='Delete', accessor='pk',
                                    attrs={'class': 'delete_link'})
...
class VendorAddress(tables.Table):
