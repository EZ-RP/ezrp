...
class Inventory(models.Model):
    ...
    available_qty = models.FloatField(null=True, blank=True, help_text="The stock that is available to the company")
    reserved_qty = models.FloatField(null=True, blank=True, help_text="The stock that is reserved for a sale")
    ordered_qty = models.FloatField(null=True, blank=True, help_text="The stock that has been ordered from a supplier")
